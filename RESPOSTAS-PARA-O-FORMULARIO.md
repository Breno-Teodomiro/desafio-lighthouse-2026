# Textos para colar no formulário

> **Não edite este arquivo** — a fonte é o `RESPOSTA.md` de cada questão, e ele
> é gerado a partir delas. Existe só para a submissão: a tentativa é única, sem
> autosave, e abrir cinco arquivos durante o preenchimento é onde o erro mora.

**Antes de colar, confira o campo.** As respostas curtas — 1.2, 3.2, 6.2 e 7.2
— estão em [`ENTREGA.md`](ENTREGA.md). Os cinco abaixo são os campos de texto.


---

## Campo 1.3  ·  5.860 caracteres
